...
Original file is located at
    https://colab.research.google.com/drive/1QJMT55g2fXoFjCgvK1QK9qFknlitc_bE
"""

!pip install tensorlayerx

#  Network models and their function format
import tensorflow
...
G_init = tlx.initializers.TruncatedNormal(mean = 1, stddev =0.02)
...
class ResidualBlock(Module):
  ...
  def _init_(self):
    ...
    ## Batch normalisation layer1

    self.bn1 = BatchNorm2d(num_features = 64, act= tlx.ReLU, gamma_init = G_init, data_format = 'channels_first')

    ## Convolutional Layer 2
    self.conv2 = Conv2d(
        out_channels = 64, kernel_size =(3,3), act = None, padding = 'SAME', W_init = W_init,
        data_format = 'chnnels_first', b_init = None

    )

    # Batch Normalisatiion layer 2
    self.bn2 = BatchNorm2d(num_features = 64, act= tlx.ReLU, gamma_init = G_init, data_format = 'channels_first' )
...
"""## SRGAN Module
### 2 generators and 3 discriminators are used in the model
